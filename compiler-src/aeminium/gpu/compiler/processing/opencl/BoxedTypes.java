...
public class BoxedTypes {
	...
	static {
		...
		typeVariables.put("java.lang.Integer#MAX_VALUE", new Integer(Integer.MAX_VALUE).toString());	
		typeVariables.put("java.lang.Long#MAX_VALUE", new Long(Long.MAX_VALUE).toString());
		typeVariables.put("java.lang.Float#MAX_VALUE", new Float(Float.MAX_VALUE).toString());	
	}
