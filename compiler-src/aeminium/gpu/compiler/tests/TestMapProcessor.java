...
public class TestMapProcessor extends TestCase {
	...
	public void compareJavaWithOpenCL(String java, String... openclS)
			throws Exception {
	...
	public void testEvenReturn() throws Exception {
		compareJavaWithOpenCL("return (input % 2 == 0) ? 1 : 2;",
	...
	public void testMathSin() throws Exception {
		compareJavaWithOpenCL("return (float) Math.sin(input);",
				"return ((float)(sin((double) input)))");
	}

	@Test
	public void testMathCos() throws Exception {
		compareJavaWithOpenCL("return (float) Math.cos(input);",
				"return ((float)(cos((double) input)));");
	}

	@Test
	public void testMathHypot() throws Exception {
		compareJavaWithOpenCL("return (float) Math.hypot(input, input);",
